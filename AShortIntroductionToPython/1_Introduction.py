...
#   1.  A basic knowledge of some programming structures. No previous experience of python is assumed, 
#       but may be helpful
#   2.  The python interpreter. This tutorial assumes python 3, and the user is strongly discouraged 
#       from using python 2.
#   3.  A python development environment. This tutorial is generally distributed as a Visual Studio 
#       project file, and although Visual Studio is not required, it is recommended. Other common options 
#       include Atom, PyCharm, and etc.

# GOALS OF THIS FILE
#   1.  Provide a reader who is a complete beginner to python with a complete foundation of python 
#       programming.
#   2.  Teach a python-like thought process to help the reader create effecient python code.
#   2.  This is not an exhaustive reference on python. Not by a longshot. It is simply to give a good 
#       solid introduction and get students to a level where they can comfortably write python programs. 
#       As such, a number of topics are not included, including file io, threading, python as glue, and 
#       many more. The interested student is intended to seek out further resources. If you contact me 
#       with your specific learning desires I would be more than happy to point you to a good learning 
#       resource if I know of one thaty suits your needs.
#   3.  Inspire a love of python. Python is a very popular programming language, and for good reason. 
#       There are a lot of reasons to love python and programming. Above all else, I hope you have fun.

# How to use this tutorial:
#       To run an individual file in Visual Studio, right click on the name of the file in the Solution 
#   Explorer and click "Set as Startup File" then click "Start" or "Attach..." (depending on your version 
#   of Visual Studio) in the top bar. Readers are encouraged to run each file at least once to ensure they 
#   understand the content, and to edit files as often as they like. Experimentation is an important 
...
import random
#   In this example we import a single module, called "random." A method from this module can then be used, 
#   as follows:
random.randint(1, 10)
...
#   will makes more sense after our discussion on conditionals.

# SECTION 2 - VARIABLES
#       Python, like most other programming languages, makes heavy use of "variables," boxes into which 
#   we put information. There are four basic types of variables:
#   1.  Integer - a whole number between negative and positive infinity, ex. 4.
#   2.  Float - float is an abreviation of "floating point number." Like an integer, a float is a number, 
#       but unlike an integer a
#       float can be any rational number, ex. 3.2.
#   3.  String - a string is a series of characters enclosed with single of double quotes, ex. "cat," or 
#       '423.'
#   4.  Boolean - True or False (always written proper case).
#   Unlike some programming launguages, python is "weakly typed" meaning when we create a variable to store 
#   data, python isn't particularly picky about what sort of data we give it. As such, declaring a variable 
#   in python does not involve naming a type for that variable. For example:
a = 10
print(a)
#   We have just created a variable called "a" and set the value of a to be the integer 10. We can redefine 
#   a to be the floating point number 10.0 using the statement:
a = 10.
print(a)
#   The "." implies to python that there could potentially be a decimal portion of this number, as so we 
#   intend it to be floating point. We could also make a stand for the string "10":
a = "10"
print(a)
...
b = "10" + "10"
print(a, b)
#   Here the variable a contains the sum of 10 and 10, i.e. 20, but the variable b contains the result of 
#   "10" + "10." Python adds strings by simply combining them, making the value of b "1010." Notice also 
#   that multiple values can be printed in one print statement seperated by a comma.
